...
public class ArrayListExample {
    ...
    public static void main(String[] args) {
        ...
        //!Array list creation
        // Collection<Integer> collectionWay = new ArrayList<>();
        // List<Integer> listWay = new ArrayList<>();
        ArrayList<Integer> arrayListWay = new ArrayList<>();
...
ArrayList<Integer> intList = new ArrayList<>(List.of(1,19,2,4,8,5));
ArrayList<String> strList = new ArrayList<>(List.of("a","x","b","f","d","c"));
...
ArrayList<Integer> revList = new ArrayList<>(List.of(1,19,2,4,8,5));
